...
void VolumetricCloudPass::DrawQualityImGuiControls()
{
    ...
    ImGui::TextWrapped("雲の見え方をレールシューティング向けに調整し、Player / Enemy / Bulletが雲に埋もれにくくなる推奨プリセットです。");
